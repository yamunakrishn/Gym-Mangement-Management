...
urlpatterns = [
    ...
    path('viewattendance/', viewattendance, name='viewattendance'),
    path('profile/', profile, name='profile'),
    path('user_batch/', userbatch, name='user_batch'),
    path('trainer_home/', trainerhome, name='trainer_home'),
    path('trainer_login/', trainerlogin, name='trainer_login'),
    path('trainer_signup/', trainersignup, name='trainer_signup'),
    path('taddMember', taddMember, name='taddMember'),
    path('trainingdetails/', trainingdetails, name='trainingdetails'),
    path('tviewMember', tviewMember, name='tviewMember'),
    path('teditMember/<int:pid>', teditMember, name='teditMember'),
